...
def generate_launch_description():
    # Stanley parameters
    k = 1.0  # gain parameter
    velocity = 0.2  # constant speed
    vehicle_frame_id = 'base_link'  # vehicle frame ID

    # Square planner parameters
    radius = 0.5  # radius of the rounded corners
    side = 2.0  # length of the sides of the square
    resolution = 0.2  # interpolation resolution
